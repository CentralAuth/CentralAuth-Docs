...
The account details screen shows detailed information about a specific account you have added to the CentralAuth app.
...
To use this account to log in to any application using CentralAuth, click on the `Log in with this account` button. A new app authentication flow will be started using the selected account. See the [Using the app to log in](/user/centralauth-app/login) page for more information about logging in with the CentralAuth app.
